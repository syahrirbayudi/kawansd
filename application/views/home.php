...
<head>
	<link href="<?php echo base_url('assets/front/images/logoapps.png'); ?>" rel="shortcut icon">
	<?php $this->load->view('layout/meta'); ?>
	<title>Home - KawanSd</title>
	...
	<div class="container-fluid-full">
					...
					<div id="row bg-img" id="rentyour">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd1.jpeg') ?>" alt="0">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd2.jpeg') ?>" alt="1">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd3.jpeg') ?>" alt="2">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd4.jpeg') ?>" alt="3">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd5.jpeg') ?>" alt="4">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/kawansd6.jpeg') ?>" alt="5">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row" id="city">
			<div class="section">
				<div class="col-md-12 text-center">
					<h5 class="font-purple font-bold font-xl">KawanSd</h5>
					<p class="font-medium font-md">Bersama Membangun Mimpi</p>
					<br><br>
		...
		<div class="row bg-img" id="rentyour">
			<div class="section font-white">
				<div class="col-md-12 text-center">
					<h2 class="font-lg font-bold ">Sekilas KawanSd</h2><br>
					<div class="col-md-6">
						<p class="font-md font-medium">KawanSd Merupakan gerakan sosial yang membantu anak sekolah dasar (sd) yang kurang beruntung.</p>
					</div>
					<div class="col-md-6">
						<p class="font-md font-medium">Program-program sosial dan pemberdayaan masyarakat tidak mampu yang digulirkan telah menjadikan dana masyarakat yang dihimpun KawanSd memiliki nilai tambah dan manfaat yang berlipat ganda bagi masyarakat kurang mampu. Karena KawanSd berusaha senantiasa menumbuhkan iklim transparansi dan profesionalitas untuk mengawal amanah masyarakat yang demikian besar. </p>
					</div>
					<br>
				</div>
			</div>
