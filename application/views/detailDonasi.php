        ...
        ?>
            <div class="col-md-12 text-center mt-inner">
                ...
                <div class="thumbnail col-md-6">
                    ...
                    <a href="<?php echo base_url('/Donatur/register/' . $row->id_donasi); ?>" class="btn btn-success btn-lg btn-block" role="button">Donasi</a>
                    <a href="https://api.whatsapp.com/send?phone=6281361626136&text=Halo%2C%20Saya%20tertartik%20menjadi%20salah%20satu%20Relawan%20KawanSd" onclick="alert('Chat Admin Untuk Lebih Lanjut')" class="btn btn-success btn-lg btn-block" role="button">Relawan</a>
                </div>
